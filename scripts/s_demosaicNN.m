...
methods that are necessary to run the PyTorch model.

  conda activate py39
  conda install --yes --file utility/python/requirements.txt
%}
...
%
%{
  scene = sceneFromFile('Feng_Office-hdrs.mat',???)
%}
oi = oiCreate('wvf');
