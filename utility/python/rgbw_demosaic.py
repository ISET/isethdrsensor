...
def rgbw_demosaic(model_path, input_path, output_path):
    ...
    def crop_and_infer(img, target_height, target_width, original_height, original_width):
        padded_img = pad_image(img, target_height, target_width)
        padded_height, padded_width, _ = padded_img.shape
        output_image = np.zeros((original_height, original_width, 4), dtype=np.float32)
    ...
    processed_img = crop_and_infer(img, 512, 512, original_height, original_width)
...
# # Example usage
# rgbw_demosaic(
#     '/Users/zhenyi/Desktop/NNDemosaicRGBW.onnx',
#     '/Users/zhenyi/git_repo/dev/iset3d-tiny/local/tmp.exr',
#     '/Users/zhenyi/git_repo/dev/isethdrsensor/sensorEXR_test_1.exr'
# )
